CREATE TABLE CENTERS (CENTER_ID INT PRIMARY KEY,
...
CREATE TABLE BASIC_SERVICES (BASIC_SERVICE_ID INT PRIMARY KEY,
                 ...
                 TOTAL_COST FLOAT NOT NULL,
                  IS_IN_WARRANTY CHAR(1) NOT NULL CHECK (IS_IN_WARRANTY = 'Y' OR IS_IN_WARRANTY='N'),
                 PARTS_ID INT NOT NULL,
                CONSTRAINT P_ID FOREIGN KEY(PARTS_ID) REFERENCES CENTERS(CENTER_ID));
...
CREATE  TABLE MAINTAINENCE_INVOICE(MAINTAINENCE_SERVICE_ID INT NOT NULL,
                DATE_OF_SERVICE DATE NOT NULL,
                PRIMARY KEY(MAINTAINENCE_SERVICE_ID,DATE_OF_SERVICE) ,
FOREIGN KEY(MAINTAINENCE_SERVICE_ID) REFERENCES MAINTENANCE_SERVICE(SERVICE_ID) ON DELETE CASCADE);
...
CREATE TABLE VEHICLES(CUSTOMER_ID INT NOT NULL,
...
CREATE TABLE FULFILLS(DISTRIBUTOR_ID INT,
                ORDER_ID INT,
...
CREATE TABLE ACCEPTS(CUSTOMER_ID INT,
                SCHEDULER_DATE DATE ,
                SLOT_NUMBER INT,
                             TIME_DURATION VARCHAR2(50),
                APPOINTMENT_ID,
...
CREATE TABLE SCHEDULES(CUSTOMER_ID INT,
                SCHEDULER_DATE DATE,
                SLOT_NUMBER INT,
                             TIME_DURATION VARCHAR2(50),
